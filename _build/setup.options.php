...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
  ...
  case xPDOTransport::ACTION_UPGRADE:
      ...
      $setting = $modx->getObject('modSystemSetting',array('key' => 'modshopify.multipass_secret'));
      if ($setting != null) { $values['multipassSecret'] = $setting->get('value'); }
      unset($setting);
...
<label for="modshopify-multipassSecret">Multipass Secret:</label>
<input type="text" name="multipassSecret" id="modshopify-multipassSecret" width="300" value="'.$values['multipassSecret'].'" />
