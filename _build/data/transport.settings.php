...
$settings['modshopify.multipass_secret']= $modx->newObject('modSystemSetting');
$settings['modshopify.multipass_secret']->fromArray(array(
    'key' => 'modshopify.multipass_secret',
    'value' => '',
    'xtype' => 'textfield',
